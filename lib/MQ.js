...
// Once the connection is setup, this will hold the default OAE task exchange
...
if (SettingsUtil.oae && SettingsUtil.oae.mq) {
    connectionOptions = SettingsUtil.oae.mq;
}
...
connection.on('error', function(err) {
    ...
    console.error('Error in the RabbitMQ connection. Reconnecting');
    console.error(err);
});
